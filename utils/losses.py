...
class ConfidenceBasedCE(nn.Module):
    ...
    def __init__(self, max_prob, confidence_quantile, apply_class_balancing):
        ...
        self.threshold = np.quantile(max_prob.numpy(), confidence_quantile)
    ...
    def forward(self, anchors_weak, anchors_strong):
        ...
        return loss, target_masked.size(0)
